...
[if exp="sf.startVoice == 0 && f.playedStartVoice == false"]
  [playse storage="noname_1/4.ogg" volume="&tf.voice_volume"]
[elsif exp="sf.startVoice == 1 && f.playedStartVoice == false"]
  [playse storage="seira_1/117.ogg" volume="&tf.voice_volume"]
[elsif exp="sf.startVoice == 2 && f.playedStartVoice == false"]
  [playse storage="seira_1/173.ogg" volume="&tf.voice_volume"]
[elsif exp="sf.startVoice == 3 && f.playedStartVoice == false"]
  [playse storage="seira_1/1089.ogg" volume="&tf.voice_volume"]
[endif]
